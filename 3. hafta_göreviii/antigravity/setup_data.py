...
if not os.path.exists(WEEK_DIR):
    ...
    print(f"Klasör oluşturuldu: {WEEK_DIR}")
...
print(f"Python dosyası yazıldı: {SCRIPT_PATH}")

# 4. Automatically run the script
print("Veri seti oluşturma scripti çalıştırılıyor...")
